format :html do
  ...
  view :account_toolbar do |args|
    if card.accountable?
      ...
      navbar 'account-toolbar',:toggle_align=>:left, :collapsed_content=>close_link('pull-right visible-xs'), :navbar_type=>'inverse', :class=>"slotter toolbar", 'data-slot-selector'=>'.related-view > .card-frame > .card-body > .card-slot' do
        [
