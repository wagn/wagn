...
This gem is brand new and is EXPERIMENTAL.  So experimental, in fact, that none of the installation instructions below actually works yet.

If you're curious to play around, feel free.  But if you actually want to install a wagn, try the documentation at http://wagn.org/get_started
...
Edit the config/database.yml file as necessary.  The default configuration works if you have password-less root access to mysql.   More about database configuration at http://www.wagn.org/database_configuration.
