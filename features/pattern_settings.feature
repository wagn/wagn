Feature: Pattern settings
  ...
  Scenario: default setting and plus card override
    ...
    And I create Pattern "plus color" with content "{\"right\": \"color\"}"
    And I create Phrase "plus color+*new" with content "If colorblind, leave blank"
    When I go to new card named "Test"
    Then I should see "spicy"
    When I go to new card name "Test+fruit"
