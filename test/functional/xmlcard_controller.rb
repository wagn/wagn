...
class XmlcardController
  def rescue_action(e) raise e end
end

class XmlcardControllerTest < ActionController::TestCase
  ...
  def setup
    ...
    @controller = XmlcardController.new
...
#    assert_restful_routes_for XmlcardController
