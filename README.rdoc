...
This gem is brand new and is EXPERIMENTAL. If you're curious to play around, feel free! But if you want to host a production site, try the documentation at http://wagn.org/get_started
...
1. Create a new Wagn using steps 1 and 2 from the installation section above.
...
5. Follow the standard upgrade proce
