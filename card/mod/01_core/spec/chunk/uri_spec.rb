...
describe Card::Content::Chunk::URI, 'URI chunk tests' do
  it 'should test_non_matches' do
    no_match(Card::Content::Chunk::URI, 'There is no URI here')
    no_match(Card::Content::Chunk::URI,
             'One gemstone is the garnet:reddish in colour, like ruby')
  end

  it 'should test_simple_uri' do
    # Simplest case
    match_chunk(Card::Content::Chunk::URI, 'http://www.example.com',
  ...
  it 'should work with trailing slash inside html tags' do
    match_chunk(Card::Content::Chunk::URI, '<p>http://www.example.com/</p>',
                scheme: 'http', host: 'www.example.com', path: '/',
                link_text: 'http://www.example.com/'
               )
  end
  ...
  it 'should work without http://' do
    match_chunk(Card::Content::Chunk::URI, 'www.example.com',
                scheme: 'http', host: 'www.example.com', text: 'www.example.com', link_text: 'http://www.example.com'
               )
    match_chunk(Card::Content::Chunk::URI, 'example.com',
  ...
  it 'should work with another "unusual" base domain' do
    match_chunk(Card::Content::Chunk::URI, 'http://www.example.co.uk/',
                scheme: 'http', host: 'www.example.co.uk',
                link_text: 'http://www.example.co.uk/'
               )
    match_chunk(Card::Content::Chunk::URI, 'example.co.uk',
  ...
  it 'should work with some path at the end' do
    match_chunk(Card::Content::Chunk::URI, 'http://moinmoin.wikiwikiweb.de/HelpOnNavigation',
  ...
  it 'should work with some path at the end, and withot http:// prefix (@link_text has prefix added)' do
    match_chunk(Card::Content::Chunk::URI, 'moinmoin.wikiwikiweb.de/HelpOnNavigation',
                scheme: 'http', host: 'moinmoin.wikiwikiweb.de', path: '/HelpOnNavigation',
  ...
  it 'should work with a port number' do
    match_chunk(Card::Content::Chunk::URI, 'http://www.example.com:80',
  ...
  it 'should work with a port number and a path' do
    match_chunk(Card::Content::Chunk::URI, 'http://www.example.com.tw:80/HelpOnNavigation',
  ...
  it 'should work with a query' do
    match_chunk(Card::Content::Chunk::URI, 'http://www.example.com.tw:80/HelpOnNavigation?arg=val',
                scheme: 'http', host: 'www.example.com.tw', port: 80, path: '/HelpOnNavigation',
                query: 'arg=val',
                link_text: 'http://www.example.com.tw:80/HelpOnNavigation?arg=val')
  end
  it 'should work on Query with two arguments' do
    match_chunk(Card::Content::Chunk::URI, 'http://www.example.com.tw:80/HelpOnNavigation?arg=val&arg2=val2',
                scheme: 'http', host: 'www.example.com.tw', port: 80, path: '/HelpOnNavigation',
                query: 'arg=val&arg2=val2',
                link_text: 'http://www.example.com.tw:80/HelpOnNavigation?arg=val&arg2=val2')
  end
  it 'should work with IRC' do
    match_chunk(Card::Content::Chunk::URI, 'irc://irc.freenode.net#recentchangescamp',
  ...
  # match_chunk(Card::Content::Chunk::URI, 'foobar://www.example.com',
  ...
  it 'should run more basic cases' do
    ...
    no_match(Card::Content::Chunk::URI, "background: url('http://dl.dropbox.com/u/4657397/wikirate/wikirate_files/wr-bg-menu-line.gif') repeat-x;")

    # Soap opera (the most complex case imaginable... well, not really, there should be more evil)
    match_chunk(Card::Content::Chunk::URI, 'http://www.example.com.tw:80/~jdoe123/Help%20Me%20?arg=val&arg2=val2',
    ...
    match_chunk(Card::Content::Chunk::URI, 'http://www2.pos.to/~tosh/ruby/rdtool/en/doc/rd-draft.html',
                scheme: 'http', host: 'www2.pos.to',
                path: '/~tosh/ruby/rdtool/en/doc/rd-draft.html')

    match_chunk(Card::Content::Chunk::URI, 'http://support.microsoft.com/default.aspx?scid=kb;en-us;234562',
                scheme: 'http', host: 'support.microsoft.com', path: '/default.aspx',
                query: 'scid=kb;en-us;234562')
  end

  it 'should test_email_uri' do
    match_chunk(Card::Content::Chunk::URI, 'mail@example.com',
  ...
  it 'should test_non_email' do
    ...
    match_chunk(Card::Content::Chunk::URI, 'Not an email: @example.com', uri: 'http://example.com')
  end
  ...
  it 'should test_textile_link' do
    ...
    # just to be sure ...
    match_chunk(Card::Content::Chunk::URI, 'This http://hobix.com/sample.jpg should match',
                link_text: 'http://hobix.com/sample.jpg')
  end

  it 'should test_inline_html' do
    no_match(Card::Content::Chunk::URI, "<img src='http://hobix.com/sample.jpg'/>")
    no_match(Card::Content::Chunk::URI, '<IMG SRC="http://hobix.com/sample.jpg">')
  end

  it 'should test_non_uri' do
    # "so" is a valid country code; "libproxy.so" is a valid url
    match_chunk(Card::Content::Chunk::URI, 'libproxy.so', host: 'libproxy.so', text: 'libproxy.so', link_text: 'http://libproxy.so')

    no_match Card::Content::Chunk::URI, 'httpd.conf'
    # THIS ONE'S BUSTED.. Ethan fix??
    # no_match Card::Content::Chunk::URI, 'ld.so.conf'
    no_match Card::Content::Chunk::URI, 'index.jpeg'
    no_match Card::Content::Chunk::URI, 'index.jpg'
    no_match Card::Content::Chunk::URI, 'file.txt'
    no_match Card::Content::Chunk::URI, 'file.doc'
    no_match Card::Content::Chunk::URI, 'file.pdf'
    no_match Card::Content::Chunk::URI, 'file.png'
    no_match Card::Content::Chunk::URI, 'file.ps'
  end

  it 'should test_uri_in_text' do
    match_chunk(Card::Content::Chunk::URI, 'Go to: http://www.example.com/', host: 'www.example.com', path: '/')
    match_chunk(Card::Content::Chunk::URI, 'http://www.example.com/ is a link.', host: 'www.example.com')
    match_chunk(Card::Content::Chunk::URI,
                'Email david@loudthinking.com',
                scheme: 'mailto', to: 'david@loudthinking.com', host: nil)
    # check that trailing punctuation is not included in the hostname
    match_chunk(Card::Content::Chunk::URI, 'Hey dude, http://fake.link.com.', scheme: 'http', host: 'fake.link.com')
    # this is a textile link, no match please.
    no_match(Card::Content::Chunk::URI, '"link":http://fake.link.com.')
  end

  it 'should test_uri_in_parentheses' do
    match_chunk(Card::Content::Chunk::URI, 'URI (http://brackets.com.de) in brackets', host: 'brackets.com.de')
    match_chunk(Card::Content::Chunk::URI, 'because (as shown at research.net) the results', host: 'research.net')
    match_chunk(Card::Content::Chunk::URI,
 ...
 describe Card::Content::Chunk::URI, 'URI chunk tests' do
   it 'should test_local_urls' do
     # normal
     match_chunk(Card::Content::Chunk::URI, 'http://perforce:8001/toto.html',
                 scheme: 'http', host: 'perforce',
                 port: 8001, link_text: 'http://perforce:8001/toto.html')

     # in parentheses
     match_chunk(Card::Content::Chunk::URI, 'URI (http://localhost:2500) in brackets',
                 host: 'localhost', port: 2500)
     match_chunk(Card::Content::Chunk::URI, 'because (as shown at http://perforce:8001) the results',
