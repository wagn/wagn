...
$(window).ready ->
  ...
  switch
    when $('body').hasClass('right-sidebar')
      ...
      $('aside').addClass("col-xs-6 col-sm-3 sidebar-offcanvas sidebar-offcanvas-right")
      $('article').prepend('<button class="visible-xs-*" data-toggle="offcanvas-right">Show</button>')
    when $('body').hasClass('left-sidebar')
      wrapDeckoLayout()
      $('article').addClass("col-xs-12 col-sm-9")
      $('aside').addClass("col-xs-6 col-sm-3 sidbar-offcanvas sidebar-offcanvas-left")
      $('article').prepend('<button class="visible-xs-*" data-toggle="offcanvas-left">Show</button>')
    when $('body').hasClass('two-sidebar')
      wrapDeckoLayout()
      $('article').addClass("col-xs-6 col-sm-6")
      $('aside')[0].addClass("col-xs-6 col-sm-3 sidebar-offcanvas sidebar-offcanvas-left")
      $('aside')[1].addClass("col-xs-6 col-sm-3 sidebar-offcanvas sidebar-offcanvas-right")
      $('article').prepend('<button class="visible-xs-*" data-toggle="offcanvas-right">Show</button>')
      $('article').prepend('<button class="visible-xs-*" data-toggle="offcanvas-left">Show</button>')
