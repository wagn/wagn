...
module Wagn
  module Set::Type::FileAndImage
    ...
    view :closed_content, :type=>'image' do |args|
      _render_core :size=>:icon
    end

    view :source, :type=>'image' do |args|
      style = case
    ...
    view :source, :type=>'file' do |args|
      card.attach.url
    end
    
    view :core, :type=>'file' do |args|
    ...
    view :editor, {:type=>:file}, {:type=>:image}

    view :diff, :type=>'image' do |args|
      out = ''
