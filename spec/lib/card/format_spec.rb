...
#    assert_equal "<a class=\"known-card\" href=\"/Harvey+business\">#{Card::Name.joint}business</a>", slot_link(dude)
#  end

#  def test_relative_link_xml
#    dude,job = newcard('Harvey',"[[#{Card::Name.joint}business]]"), newcard('business')
#    card = dude.connect job, "icepicker"
#    assert_equal "<cardref class=\"known-card\" card=\"Harvey+business\">#{Card::Name.joint}business</cardref>", slot_link(dude,:xml)
#  end
end
