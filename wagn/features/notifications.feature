Feature: Notifications
  ...
  Scenario: Watching a Card
    ...
    And the card All Eyes On Me+*followers should contain "Joe User"
# FIXME:need multiline matching
    And I should see "was just edited by Joe User" in the email body
    #And He should see "You received this email because you're watching Home" in the email
    When I follow "Unfollow" in the email
    Then the card All Eyes On Me+*followers should not contain "Joe User"
  ...
  Scenario: Watching a Type Card
    ...
    And the card +*followers should contain "Phrase"
    # FIXME:need multiline matching
