class Card::Log
  ...
  class Performance
    ...
    @@log = []
    @@category_log = Performance::CategoryLog.new
    @@context_entries = []
    @@active_entries = []
    @@current_level = 0
...
#         }
      ...
      def start args={}
        ...
        @@category_log = Performance::CategoryLog.new args[:category]
      end
      ...
      def prepare_methods_for_logging args
        ...
        classes.each do |klass, method_types|
          klass.extend Card::Log::Performance::BigBrother  # add watch methods
