module Wagn::Model
  module Pattern
    ...
    def real_set_names()
      r=(sn=set_names).find_all { |set_name| Card.exists? set_name }
      #warn "rsn #{sn.inspect}, #{r.inspect}"; r
    end
  ...
  class SetBase
    ...
    class << self
      def key_name()
        ...
        Card::Codename[self.key] || self.key end
    ...
    def opt_vals()        []                                           end
    def set_name() (opt_vals << self.class.key_name).to_cardname.to_s  end
    def get_method_key()
