...
describe Card::Content::Chunk::URI, 'URI chunk tests' do
  ...
  it 'works without http://' do
    match_http_uri 'www.example.com',
                   ...
                   text: 'www.example.com', link_text: 'http://www.example.com'
    match_http_uri 'example.com',
                   host: 'example.com',
                   text: 'example.com', link_text: 'http://example.com'
  end
  ...
  it 'works with "unusual" base domain without http://' do
    match_http_uri 'example.com.au',
                   host: 'example.com.au',
                   text: 'example.com.au', link_text: 'http://example.com.au'
  end
  it 'works with another "unusual" base domain' do
    ...
    match_http_uri 'example.co.uk',
                   host: 'example.co.uk',
                   link_text: 'http://example.co.uk', text: 'example.co.uk'
  end
  ...
  it 'should see HTTPS' do
    match_uri 'https://www.example.com',
              scheme: 'https', host: 'www.example.com', port: 443, path: '', 
              query: nil
  end
  it 'should see FTP' do
    match_uri 'ftp://www.example.com',
              scheme: 'ftp', host: 'www.example.com', port: 21, path: '', 
              query: nil
  end
  ...
  # match_uri 'foobar://www.example.com',
  ...
  it 'should run more basic cases' do
    ...
    no_match_uri "background: url('http://dl.dropbox.com/u/4657397/wikirate/wikirate_files/wr-bg-menu-line.gif') repeat-x;"

    # Soap opera (the most complex case imaginable... well, not really, there should be more evil)
    match_http_uri 'http://www.example.com.tw:80/~jdoe123/Help%20Me%20?arg=val&arg2=val2',
                   host: 'www.example.com.tw', port: 80,
  ...
  it 'should test_email_uri' do
    match_uri 'mail@example.com',
              to: 'mail@example.com', host: nil, text: 'mail@example.com',
  ...
  it 'should test_non_uri' do
    ...
    match_uri 'libproxy.so', host: 'libproxy.so', text: 'libproxy.so',
  ...
  it 'should test_interesting_uri_with__comma' do
    ...
    match_uri "This text contains a URL http://someplace.org:8080/~person/stuff.cgi?arg=val, doesn't it?",
