  ...
  class RefSpec < Spec
    def initialize(spec)
      ...
      @refspecs = {
        ...
        :include        => ['card_id','referenced_card_id',"link_type='#{Card::Reference::INCLUSION}' AND"],
        ...
        :included_by    => ['referenced_card_id','card_id',"link_type='#{Card::Reference::INCLUSION}' AND"]
      }
    end
