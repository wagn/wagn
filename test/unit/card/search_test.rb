...
class Card::BaseTest < ActiveSupport::TestCase
  ...
  def test_autocard_should_not_break_if_extension_missing
    assert_equal "", Card.pattern_virtual("A+*email").content
  end
